...
public class ElasticSearchControllerTest {
    ...
    public void testAddUsersTask() {
        UserAccount u1 = new UserAccount("NightsWatcher", "John Snow", null);
        u1.setUID(6);
...
/*
    ...
    public void testGetAllUsers() {
        ElasticSearchController.GetAllUsers getAllUsers = new ElasticSearchController.GetAllUsers();
        getAllUsers.execute();
        ...
        try {
            ...
            Log.i("Error", "Failed to get all users from async object");
        }
        for (UserAccount user : users) {
            Log.i("DeBug", "User uid is: " + user.getUID());
        }

        Log.i("DeBug", "Size of users list: " + users.size());
    }
}
*/
    @Test
...
/*
    ...
    public void testGetMaxHid() {
        ...
        Log.i("Debug", "maxHid returns: " + Integer.toString(MaxHID));
